...
import cn.noname.app.model.User;
...
public RecyclerViewAdapter(List<User> l, Context c){
    ...
    public void onBindViewHolder(DataHolder holder, final int position) {
        ...
        if(holder instanceof DataHolder) {
            ...
            glideImageLoader.displayImage(context,listItem.getAvatar(),holder.imageView);
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    listener.onItemClick(position,listItem.getNickName());
                }
            });
        }
