package cn.noname.app.widget.downloadService;
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT>= Build.VERSION_CODES.N){
                Uri fileUri = FileProvider.getUriForFile(DownloadService.this,getPackageName()+".provider",apkFile);
...
//参考资料：https://www.jianshu.com/p/af37c1c588c4
