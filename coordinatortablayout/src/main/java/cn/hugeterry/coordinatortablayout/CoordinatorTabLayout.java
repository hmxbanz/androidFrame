...
//        int tabIndicatorColor = typedArray.getColor(R.styleable.CoordinatorTabLayout_tabIndicatorColor, getResources().getColor(R.color.mainColorBlueDark));
//        mTabLayout.setSelectedTabIndicatorColor(tabIndicatorColor);
//
//        int tabTextColor = typedArray.getColor(R.styleable.CoordinatorTabLayout_tabTextColor, getResources().getColor(R.color.mainColorBlueDark));
